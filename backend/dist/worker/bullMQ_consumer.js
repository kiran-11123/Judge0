...
const updateSubmissionStatus = async (userId, problemId, submissionId, status) => {
    ...
    const normalizedUserId = userId instanceof mongoose.Types.ObjectId ? userId : new mongoose.Types.ObjectId(userId);
    const normalizedProblemId = problemId instanceof mongoose.Types.ObjectId ? problemId : new mongoose.Types.ObjectId(problemId);
    const normalizedSubmissionId = submissionId instanceof mongoose.Types.ObjectId
        ? submissionId
